...
// DOCUMENT:	None
// DESCRIPTION: This file declares validation handling functions for state machine operation
...
/// Used for compile-time checking for array sizes. On Windows VC++, you get an "error C2118: negative subscript" error.
#ifndef C_ASSERT
