...
data type ReportJpegGenerationLivenessMsg from dds_msgs.idl.
This example builds two applications, named dds_msgs_publisher and
dds_msgs_subscriber.
...
1. Launch Visual Studio in one of two ways:
        - By typing dds_msgs-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          dds_msgs-x64Win64VS2017.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   dds_msgs_publisher or dds_msgs_subscriber and
...
To modify the data being sent: edit the dds_msgs_publisher.cxx
file where it says 
...
1. Right-click dds_msgs_publisher and choose Debug > Start new instance.
2. Right-click dds_msgs_subscriber and choose Debug > Start new instance.
...
> objs\x64Win64VS2017\dds_msgs_publisher.exe -d <domain_id> -s <sample_count>
> objs\x64Win64VS2017\dds_msgs_subscriber.exe -d <domain_id> -s <sample_count>
