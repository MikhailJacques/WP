...
int process_data(dds::sub::DataReader<dds_msgs::StopJpegGenerationMsg> reader)
{
    // Take all samples
    int count = 0;
    dds::sub::LoanedSamples<dds_msgs::StopJpegGenerationMsg> samples = reader.take();
...
void run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    while (!application::shutdown_requested && samples_read < sample_count) {
        ...
        std::cout << "dds_msgs::StopJpegGenerationMsg subscriber sleeping up to 1 sec..." << std::endl;
