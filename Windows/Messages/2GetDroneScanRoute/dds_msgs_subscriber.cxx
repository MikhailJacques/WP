...
int process_data(dds::sub::DataReader<dds_msgs::GetDroneScanRouteMsg> reader)
{
    // Take all samples
    int count = 0;
    dds::sub::LoanedSamples<dds_msgs::GetDroneScanRouteMsg> samples = reader.take();
...
void run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    // dds::sub::DataReader<dds_msgs::GetDroneScanRouteMsg> reader(subscriber, topic);
    dds::core::QosProvider m_qos_provider = dds::core::QosProvider::Default();
    dds::sub::DataReader<dds_msgs::GetDroneScanRouteMsg>reader(subscriber, topic, m_qos_provider.datareader_qos("WorldPerceptionQoS::GetDroneScanRouteMsg"));
    ...
    while (!application::shutdown_requested && samples_read < sample_count) {
        ...
        std::cout << "dds_msgs::GetDroneScanRouteMsg subscriber sleeping up to 1 sec..." << std::endl;
