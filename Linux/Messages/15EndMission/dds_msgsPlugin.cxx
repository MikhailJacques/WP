...
namespace dds_msgs {
    ...
    * -------------------------------------------------------------------------- */
    ...
    EndMissionMsg *
    EndMissionMsgPluginSupport_create_data(void)
    {
        try {
            EndMissionMsg *sample = new EndMissionMsg();
            ::rti::topic::allocate_sample(*sample);
            return sample;
        } catch (...) {
            return NULL;
    ...
    void 
    EndMissionMsgPluginSupport_destroy_data(
        EndMissionMsg *sample) 
    {
        delete sample;
    }

    RTIBool 
    EndMissionMsgPluginSupport_copy_data(
        EndMissionMsg *dst,
        const EndMissionMsg *src)
    {
        try {
            *dst = *src;
        } catch (...) {
    ...
    EndMissionMsg *
    EndMissionMsgPluginSupport_create_key(void)
    {
        return EndMissionMsgPluginSupport_create_data();
    }

    void 
    EndMissionMsgPluginSupport_destroy_key(
        EndMissionMsgKeyHolder *key) 
    {
        EndMissionMsgPluginSupport_destroy_data(key);
    }
    ...
    * ---------------------------------------------------------------------------- */
    ...
    PRESTypePluginParticipantData 
    EndMissionMsgPlugin_on_participant_attached(
        void *registration_data,
        const struct PRESTypePluginParticipantInfo *participant_info,
        RTIBool top_level_registration,
        void *container_plugin_context,
        RTICdrTypeCode *type_code)
    {
        ...
        programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
            DDS_TypeCodeFactory_get_instance(),
            (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EndMissionMsg >::get().native()
            ,
            &programProperty,
            RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    void 
    EndMissionMsgPlugin_on_participant_detached(
        PRESTypePluginParticipantData participant_data)
    {
        if (participant_data != NULL) {
            struct PRESTypePluginDefaultParticipantData *pd = 
    ...
    PRESTypePluginEndpointData
    EndMissionMsgPlugin_on_endpoint_attached(
        PRESTypePluginParticipantData participant_data,
        const struct PRESTypePluginEndpointInfo *endpoint_info,
        RTIBool top_level_registration, 
        void *containerPluginContext)
    {
        try {
            ...
            epd = PRESTypePluginDefaultEndpointData_new(
                ...
                endpoint_info,
                (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
                EndMissionMsgPluginSupport_create_data,
                (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                EndMissionMsgPluginSupport_destroy_data,
                (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
                dds_msgs::EndMissionMsgPluginSupport_create_key ,                (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
                dds_msgs::EndMissionMsgPluginSupport_destroy_key);

            if (epd == NULL) {
                return NULL;
            } 

            serializedKeyMaxSize =  dds_msgs::EndMissionMsgPlugin_get_serialized_key_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            serializedKeyMaxSizeV2 = EndMissionMsgPlugin_get_serialized_key_max_size_for_keyhash(
                epd,
                RTI_CDR_ENCAPSULATION_ID_CDR2_BE,
                0);
            ...
            if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                serializedSampleMaxSize = dds_msgs::EndMissionMsgPlugin_get_serialized_sample_max_size(
                    epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
                PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
                ...
                if (PRESTypePluginDefaultEndpointData_createWriterPool(
                    ...
                    endpoint_info,
                    (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                    dds_msgs::EndMissionMsgPlugin_get_serialized_sample_max_size, epd,
                    (PRESTypePluginGetSerializedSampleSizeFunction)
                    PRESTypePlugin_interpretedGetSerializedSampleSize,
                    epd) == RTI_FALSE) {
                    PRESTypePluginDefaultEndpointData_delete(epd);
    ...
    void 
    EndMissionMsgPlugin_on_endpoint_detached(
        PRESTypePluginEndpointData endpoint_data)
    {  
        PRESTypePluginDefaultEndpointData_delete(endpoint_data);
    }
    ...
    void    
    EndMissionMsgPlugin_return_sample(
        PRESTypePluginEndpointData endpoint_data,
        EndMissionMsg *sample,
        void *handle)
    {
    ...
    RTIBool 
    EndMissionMsgPlugin_copy_sample(
        PRESTypePluginEndpointData,
        EndMissionMsg *dst,
        const EndMissionMsg *src)
    {
        return dds_msgs::EndMissionMsgPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
    unsigned int 
    EndMissionMsgPlugin_get_serialized_sample_max_size(
        PRESTypePluginEndpointData endpoint_data,
        RTIBool include_encapsulation,
        RTIEncapsulationId encapsulation_id,
        unsigned int current_alignment);
    ...
    RTIBool
    EndMissionMsgPlugin_serialize_to_cdr_buffer(
        char * buffer,
        unsigned int * length,
        const EndMissionMsg *sample,
        ::dds::core::policy::DataRepresentationId representation)
    {
        using namespace ::dds::core::policy;
        ...
        try{
            ...
            epd.programContext.endpointPluginData = &epd;
            plugin.typeCode = (struct RTICdrTypeCode *)
            (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EndMissionMsg >::get().native()
            ;
            pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
            EndMissionMsg, 
            true, true, true>();
    ...
    RTIBool
    EndMissionMsgPlugin_deserialize_from_cdr_buffer(
        EndMissionMsg *sample,
        const char * buffer,
        unsigned int length)
    {
        ...
        epd.programContext.endpointPluginData = &epd;
        plugin.typeCode = (struct RTICdrTypeCode *)
        (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< EndMissionMsg >::get().native()
        ;
        pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
        EndMissionMsg, 
        true, true, true>();
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    PRESTypePluginKeyKind 
    EndMissionMsgPlugin_get_key_kind(void)
    {
        return PRES_TYPEPLUGIN_USER_KEY;
    }

    RTIBool EndMissionMsgPlugin_deserialize_key(
        PRESTypePluginEndpointData endpoint_data,
        EndMissionMsg **sample, 
        RTIBool * drop_sample,
        struct RTICdrStream *stream,
    ...
    unsigned int
    EndMissionMsgPlugin_get_serialized_key_max_size(
        PRESTypePluginEndpointData endpoint_data,
        RTIBool include_encapsulation,
        RTIEncapsulationId encapsulation_id,
        unsigned int current_alignment)
    ...
    unsigned int
    EndMissionMsgPlugin_get_serialized_key_max_size_for_keyhash(
        PRESTypePluginEndpointData endpoint_data,
        RTIEncapsulationId encapsulation_id,
        unsigned int current_alignment)
    {
    ...
    RTIBool 
    EndMissionMsgPlugin_instance_to_key(
        PRESTypePluginEndpointData endpoint_data,
        EndMissionMsgKeyHolder *dst, 
        const EndMissionMsg *src)
    {
        try {
            if (!dds_msgs::BaseMsgPlugin_instance_to_key(endpoint_data,(dds_msgs::BaseMsg *)dst,(const dds_msgs::BaseMsg*)src)) {
    ...
    RTIBool 
    EndMissionMsgPlugin_key_to_instance(
        PRESTypePluginEndpointData endpoint_data,
        EndMissionMsg *dst, const
        EndMissionMsgKeyHolder *src)
    {
        try {
            if (!dds_msgs::BaseMsgPlugin_key_to_instance(endpoint_data,(dds_msgs::BaseMsg*)dst,(const dds_msgs::BaseMsg*)src)) {
                return RTI_FALSE;
    ...
    RTIBool 
    EndMissionMsgPlugin_serialized_sample_to_keyhash(
        PRESTypePluginEndpointData endpoint_data,
        struct RTICdrStream *stream, 
        DDS_KeyHash_t *keyhash,
        RTIBool deserialize_encapsulation,
        void *endpoint_plugin_qos)
    {
        EndMissionMsg * sample = NULL;
        sample = (EndMissionMsg *)
        PRESTypePluginDefaultEndpointData_getTempSample(endpoint_data);
        if (sample == NULL) {
            return RTI_FALSE;
        }
    ...
    * Plug-in Installation Methods
    * ------------------------------------------------------------------------ */
    struct PRESTypePlugin *EndMissionMsgPlugin_new(void) 
    { 
        struct PRESTypePlugin *plugin = NULL;
        const struct PRESTypePluginVersion PLUGIN_VERSION = 
        PRES_TYPE_PLUGIN_VERSION_2_0;
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        dds_msgs::EndMissionMsgPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        dds_msgs::EndMissionMsgPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        dds_msgs::EndMissionMsgPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        dds_msgs::EndMissionMsgPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        dds_msgs::EndMissionMsgPlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        EndMissionMsgPlugin_create_sample;
        plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        EndMissionMsgPlugin_destroy_sample;
        ...
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        dds_msgs::EndMissionMsgPlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        PRESTypePlugin_interpretedGetSerializedSampleMinSize;
        plugin->getDeserializedSampleMaxSizeFnc = NULL; 
        plugin->getSampleFnc =
        (PRESTypePluginGetSampleFunction)
        EndMissionMsgPlugin_get_sample;
        plugin->returnSampleFnc =
        (PRESTypePluginReturnSampleFunction)
        EndMissionMsgPlugin_return_sample;
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        dds_msgs::EndMissionMsgPlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        dds_msgs::EndMissionMsgPlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        PRESTypePlugin_interpretedSerializeKey;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        dds_msgs::EndMissionMsgPlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        PRESTypePlugin_interpretedDeserializeKey;
        ...
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        dds_msgs::EndMissionMsgPlugin_serialized_sample_to_keyhash;

        plugin->getKeyFnc =
        (PRESTypePluginGetKeyFunction)
        EndMissionMsgPlugin_get_key;
        plugin->returnKeyFnc =
        (PRESTypePluginReturnKeyFunction)
        EndMissionMsgPlugin_return_key;

        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        dds_msgs::EndMissionMsgPlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        dds_msgs::EndMissionMsgPlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        #ifdef NDDS_STANDALONE_TYPE
        plugin->typeCode = NULL; 
        #else
        plugin->typeCode = (struct RTICdrTypeCode *) 
        &::rti::topic::dynamic_type< dds_msgs::EndMissionMsg >::get().native();
        #endif
        plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
        ...
        plugin->getBuffer = 
        (PRESTypePluginGetBufferFunction)
        EndMissionMsgPlugin_get_buffer;
        plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        EndMissionMsgPlugin_return_buffer;
        plugin->getBufferWithParams = NULL;
        plugin->returnBufferWithParams = NULL;
        plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        ...
        static const char * TYPE_NAME = "dds_msgs::EndMissionMsg";
        plugin->endpointTypeName = TYPE_NAME;
        plugin->isMetpType = RTI_FALSE;
        return plugin;
    }
    ...
    void
    EndMissionMsgPlugin_delete(struct PRESTypePlugin *plugin)
    {
        RTIOsapiHeap_freeStructure(plugin);
    } 
} /* namespace dds_msgs  */
