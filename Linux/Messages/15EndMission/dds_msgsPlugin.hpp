...
#ifndef dds_msgsPlugin_1583855863_h
#define dds_msgsPlugin_1583855863_h
...
namespace dds_msgs {
    ...
    * AnotherSimple.
    *
    * By default, this type is struct EndMissionMsg
    * itself. However, if for some reason this choice is not practical for your
    * system (e.g. if sizeof(struct EndMissionMsg)
    * is very large), you may redefine this typedef in terms of another type of
    * your choosing. HOWEVER, if you define the KeyHolder type to be something
    * other than struct AnotherSimple, the
    * following restriction applies: the key of struct
    * EndMissionMsg must consist of a
    * single field of your redefined KeyHolder type and that field must be the
    * first field in struct EndMissionMsg.
    */
    typedef  class EndMissionMsg EndMissionMsgKeyHolder;

    #define EndMissionMsgPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample

    #define EndMissionMsgPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
    #define EndMissionMsgPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer

    #define EndMissionMsgPlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
    #define EndMissionMsgPlugin_return_key PRESTypePluginDefaultEndpointData_returnKey

    #define EndMissionMsgPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
    #define EndMissionMsgPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

    /* --------------------------------------------------------------------------------------
    Support functions:
    * -------------------------------------------------------------------------------------- */

    NDDSUSERDllExport extern EndMissionMsg*
    EndMissionMsgPluginSupport_create_data_w_params(
        const struct DDS_TypeAllocationParams_t * alloc_params);

    NDDSUSERDllExport extern EndMissionMsg*
    EndMissionMsgPluginSupport_create_data_ex(RTIBool allocate_pointers);
    ...
    EndMissionMsgPluginSupport_copy_data(
        EndMissionMsg *out,
        const EndMissionMsg *in);

    NDDSUSERDllExport extern void 
    EndMissionMsgPluginSupport_destroy_data_w_params(
        EndMissionMsg *sample,
        const struct DDS_TypeDeallocationParams_t * dealloc_params);

    NDDSUSERDllExport extern void 
    EndMissionMsgPluginSupport_destroy_data_ex(
        EndMissionMsg *sample,RTIBool deallocate_pointers);
    ...
    NDDSUSERDllExport extern void 
    EndMissionMsgPluginSupport_print_data(
        const EndMissionMsg *sample,
        const char *desc,
        unsigned int indent);

    NDDSUSERDllExport extern EndMissionMsg*
    EndMissionMsgPluginSupport_create_key_ex(RTIBool allocate_pointers);

    NDDSUSERDllExport extern EndMissionMsg*
    EndMissionMsgPluginSupport_create_key(void);

    NDDSUSERDllExport extern void 
    EndMissionMsgPluginSupport_destroy_key_ex(
        EndMissionMsgKeyHolder *key,RTIBool deallocate_pointers);
    ...
    * ------------------------------------------------------------------------- */
    ...
    NDDSUSERDllExport extern RTIBool 
    EndMissionMsgPlugin_deserialize(
        PRESTypePluginEndpointData endpoint_data,
        EndMissionMsg **sample, 
        RTIBool * drop_sample,
        struct RTICdrStream *stream,
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    NDDSUSERDllExport extern RTIBool 
    EndMissionMsgPlugin_deserialize_key(
        PRESTypePluginEndpointData endpoint_data,
        EndMissionMsg ** sample,
        RTIBool * drop_sample,
        struct RTICdrStream *stream,
    ...
    EndMissionMsgPlugin_instance_to_key(
        PRESTypePluginEndpointData endpoint_data,
        EndMissionMsgKeyHolder *key, 
        const EndMissionMsg *instance);

    NDDSUSERDllExport extern RTIBool 
    EndMissionMsgPlugin_key_to_instance(
        PRESTypePluginEndpointData endpoint_data,
        EndMissionMsg *instance, 
        const EndMissionMsgKeyHolder *key);
    ...
    /* Plugin Functions */
    NDDSUSERDllExport extern struct PRESTypePlugin*
    EndMissionMsgPlugin_new(void);

    NDDSUSERDllExport extern void
    EndMissionMsgPlugin_delete(struct PRESTypePlugin *);
...
#endif /* dds_msgsPlugin_1583855863_h */
