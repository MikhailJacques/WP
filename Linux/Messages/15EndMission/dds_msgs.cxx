...
namespace dds_msgs {
    ...
    #ifdef RTI_CXX11_RVALUE_REFERENCES
    #ifdef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
    EndMissionMsg::EndMissionMsg(EndMissionMsg&& other_) OMG_NOEXCEPT  : 
    dds_msgs::BaseMsg(std::move(other_))  {
    } 

    EndMissionMsg& EndMissionMsg::operator=(EndMissionMsg&&  other_) OMG_NOEXCEPT {
        EndMissionMsg tmp(std::move(other_));
        swap(tmp); 
        return *this;
    }
    #endif
    ...
    void EndMissionMsg::swap(EndMissionMsg& other_)  OMG_NOEXCEPT 
    {
        using std::swap;
        dds_msgs::BaseMsg::swap(other_);
    }  

    bool EndMissionMsg::operator == (const EndMissionMsg& other_) const {
        if (!dds_msgs::BaseMsg::operator == (other_)){
            return false;
        }
        return true;
    ...
    std::ostream& operator << (std::ostream& o,const EndMissionMsg& sample)
    {
        ::rti::util::StreamFlagSaver flag_saver (o);
        o <<"[";
        o << static_cast<const dds_msgs::BaseMsg &>(sample);
...
namespace rti { 
    namespace topic {
        ...
        #ifndef NDDS_STANDALONE_TYPE
        template<>
        struct native_type_code< dds_msgs::EndMissionMsg > {
            static DDS_TypeCode * get()
            {
                using namespace ::rti::topic::interpreter;
                ...
                static DDS_TypeCode EndMissionMsg_g_tc =
                {{
                        DDS_TK_VALUE, /* Kind */
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"dds_msgs::EndMissionMsg", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                        ...
                        NULL, /* _sampleAccessInfo: assigned later */
                        NULL /* _typePlugin: assigned later */
                    }}; /* Type code for EndMissionMsg*/

                if (is_initialized) {
                    return &EndMissionMsg_g_tc;
                }

                EndMissionMsg_g_tc._data._annotations._allowedDataRepresentationMask = 5;

                /* Initialize the values for member annotations. */

                EndMissionMsg_g_tc._data._typeCode = (RTICdrTypeCode *)&::rti::topic::dynamic_type< dds_msgs::BaseMsg >::get().native(); /* Base class */

                EndMissionMsg_g_tc._data._sampleAccessInfo = sample_access_info();
                EndMissionMsg_g_tc._data._typePlugin = type_plugin_info();    
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrSampleAccessInfo EndMissionMsg_g_sampleAccessInfo = 
                RTIXCdrSampleAccessInfo_INITIALIZER;

                if (is_initialized) {
                    return (RTIXCdrSampleAccessInfo*) &EndMissionMsg_g_sampleAccessInfo;
                }

                {
                    size_t candidateTypeSize = sizeof(dds_msgs::EndMissionMsg);

                    if (candidateTypeSize > RTIXCdrLong_MAX) {
                        EndMissionMsg_g_sampleAccessInfo.typeSize[0] =
                        RTIXCdrLong_MAX;
                    } else {
                        EndMissionMsg_g_sampleAccessInfo.typeSize[0] =
                        (RTIXCdrUnsignedLong) candidateTypeSize;
                ...
                EndMissionMsg_g_sampleAccessInfo.useGetMemberValueOnlyWithRef =
                RTI_XCDR_TRUE;

                EndMissionMsg_g_sampleAccessInfo.getMemberValuePointerFcn = 
                interpreter::get_aggregation_value_pointer< dds_msgs::EndMissionMsg >;

                EndMissionMsg_g_sampleAccessInfo.languageBinding = 
                RTI_XCDR_TYPE_BINDING_CPP_11_STL ;
            ...
            static RTIXCdrTypePlugin * type_plugin_info()
            {
                static RTIXCdrTypePlugin EndMissionMsg_g_typePlugin = 
                {
                    NULL, /* serialize */
                    NULL, /* serialize_key */
                    NULL, /* deserialize_sample */
                ...
                return &EndMissionMsg_g_typePlugin;
            }
        }; // native_type_code
        #endif

        const ::dds::core::xtypes::StructType& dynamic_type< dds_msgs::EndMissionMsg >::get()
        {
            return static_cast<const ::dds::core::xtypes::StructType&>(
                ::rti::core::native_conversions::cast_from_native< ::dds::core::xtypes::DynamicType >(
                    *(native_type_code< dds_msgs::EndMissionMsg >::get())));
        }
...
namespace dds { 
    namespace topic {
        ...
        void topic_type_support< dds_msgs::EndMissionMsg >:: register_type(
            ::dds::domain::DomainParticipant& participant,
            const std::string& type_name) 
        {
            ...
            ::rti::domain::register_type_plugin(
                participant,
                type_name,
                dds_msgs::EndMissionMsgPlugin_new,
                dds_msgs::EndMissionMsgPlugin_delete);
        }

        std::vector<char>& topic_type_support< dds_msgs::EndMissionMsg >::to_cdr_buffer(
            std::vector<char>& buffer, 
            const dds_msgs::EndMissionMsg& sample,
            ::dds::core::policy::DataRepresentationId representation)
        {
            // First get the length of the buffer
            unsigned int length = 0;
            RTIBool ok = EndMissionMsgPlugin_serialize_to_cdr_buffer(
                NULL, 
                &length,
                &sample,
                representation);
            ...
            // Create a vector with that size and copy the cdr buffer into it
            buffer.resize(length);
            ok = EndMissionMsgPlugin_serialize_to_cdr_buffer(
                &buffer[0], 
                &length, 
                &sample,
                representation);
        ...
        void topic_type_support< dds_msgs::EndMissionMsg >::from_cdr_buffer(dds_msgs::EndMissionMsg& sample, 
        const std::vector<char>& buffer)
        {

            RTIBool ok  = EndMissionMsgPlugin_deserialize_from_cdr_buffer(
                &sample, 
                &buffer[0], 
                static_cast<unsigned int>(buffer.size()));
            ::rti::core::check_return_code(ok ? DDS_RETCODE_OK : DDS_RETCODE_ERROR,
            "Failed to create dds_msgs::EndMissionMsg from cdr buffer");
        }

        void topic_type_support< dds_msgs::EndMissionMsg >::reset_sample(dds_msgs::EndMissionMsg& sample) 
        {
            // Initialize base
            topic_type_support< dds_msgs::BaseMsg >::reset_sample(sample);
        ...
        void topic_type_support< dds_msgs::EndMissionMsg >::allocate_sample(dds_msgs::EndMissionMsg& sample, int, int) 
        {
            // Initialize base
            topic_type_support< dds_msgs::BaseMsg >::allocate_sample(sample, -1, -1);
