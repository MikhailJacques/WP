...
#ifndef dds_msgs_1583855863_hpp
#define dds_msgs_1583855863_hpp
...
namespace dds_msgs {
    ...
    class NDDSUSERDllExport EndMissionMsg
    : public dds_msgs::BaseMsg {
      public:
        EndMissionMsg();
        ...
        #ifdef RTI_CXX11_RVALUE_REFERENCES
        #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
        EndMissionMsg (EndMissionMsg&&) = default;
        EndMissionMsg& operator=(EndMissionMsg&&) = default;
        EndMissionMsg& operator=(const EndMissionMsg&) = default;
        EndMissionMsg(const EndMissionMsg&) = default;
        #else
        EndMissionMsg(EndMissionMsg&& other_) OMG_NOEXCEPT;  
        EndMissionMsg& operator=(EndMissionMsg&&  other_) OMG_NOEXCEPT;
        #endif
        #endif 

        bool operator == (const EndMissionMsg& other_) const;
        bool operator != (const EndMissionMsg& other_) const;

        void swap(EndMissionMsg& other_) OMG_NOEXCEPT ;

      private:

    };

    inline void swap(EndMissionMsg& a, EndMissionMsg& b)  OMG_NOEXCEPT 
    {
        a.swap(b);
    }

    NDDSUSERDllExport std::ostream& operator<<(std::ostream& o, const EndMissionMsg& sample);
...
namespace dds {
    namespace topic {
        ...
        template<>
        struct topic_type_name< dds_msgs::EndMissionMsg > {
            NDDSUSERDllExport static std::string value() {
                return "dds_msgs::EndMissionMsg";
            }
        };

        template<>
        struct is_topic_type< dds_msgs::EndMissionMsg > : public ::dds::core::true_type {};

        template<>
        struct topic_type_support< dds_msgs::EndMissionMsg > {
            NDDSUSERDllExport 
            static void register_type(
                ::dds::domain::DomainParticipant& participant,
                const std::string & type_name);
            ...
            NDDSUSERDllExport 
            static void from_cdr_buffer(dds_msgs::EndMissionMsg& sample, const std::vector<char>& buffer);
            NDDSUSERDllExport 
            static void reset_sample(dds_msgs::EndMissionMsg& sample);

            NDDSUSERDllExport 
            static void allocate_sample(dds_msgs::EndMissionMsg& sample, int, int);
...
namespace rti { 
    namespace topic {
        ...
        #ifndef NDDS_STANDALONE_TYPE
        template<>
        struct dynamic_type< dds_msgs::EndMissionMsg > {
            typedef ::dds::core::xtypes::StructType type;
            NDDSUSERDllExport static const ::dds::core::xtypes::StructType& get();
        };
        #endif
        ...
        template <>
        struct extensibility< dds_msgs::EndMissionMsg > {
            static const ::dds::core::xtypes::ExtensibilityKind::type kind =
            ::dds::core::xtypes::ExtensibilityKind::EXTENSIBLE;                
        };
