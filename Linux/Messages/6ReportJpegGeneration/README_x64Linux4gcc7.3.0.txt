...
> make -f makefile_dds_msgs_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_dds_msgs_x64Linux4gcc7.3.0 DEBUG=1
...
Run /home/user/rti_connext_dds-6.1.0/resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/dds_msgs_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/dds_msgs_subscriber -d <domain_id> -s <sample_count>
