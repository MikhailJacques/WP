...
void run_publisher_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    //dds::pub::DataWriter<dds_msgs::DoubleUrlMsg> writer(publisher, topic);
    dds::core::QosProvider m_qos_provider = dds::core::QosProvider::Default();
    dds::pub::DataWriter<dds_msgs::DoubleUrlMsg> writer(publisher, topic, m_qos_provider.datawriter_qos("WorldPerceptionQoS::RequestRefModelMsg"));


    dds_msgs::DoubleUrlMsg data;
    ...
    for (unsigned int samples_written = 0; !application::shutdown_requested && samples_written < sample_count; samples_written++)
    {
        ...
        writer.write(data);
        std::cout << "Writing RequestRefModelMsg, count " << samples_written << std::endl;
