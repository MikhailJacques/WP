...
void run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    dds::topic::Topic<dds_msgs::DoubleUrlMsg> topic(participant, "RequestRefModelMsg");
    ...
    dds::sub::DataReader<dds_msgs::DoubleUrlMsg>reader(subscriber, topic, m_qos_provider.datareader_qos("WorldPerceptionQoS::RequestRefModelMsg"));
    ...
    while (!application::shutdown_requested && samples_read < sample_count) {
        ...
        std::cout << "RequestRefModelMsg subscriber sleeping up to 1 sec..." << std::endl;
