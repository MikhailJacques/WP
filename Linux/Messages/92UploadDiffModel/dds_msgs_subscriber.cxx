...
void run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    dds::topic::Topic<dds_msgs::DoubleUrlMsg> topic(participant, "UploadDiffModelMsg");
    ...
    dds::sub::DataReader<dds_msgs::DoubleUrlMsg>reader(subscriber, topic, m_qos_provider.datareader_qos("WorldPerceptionQoS::UploadDiffModelMsg"));
