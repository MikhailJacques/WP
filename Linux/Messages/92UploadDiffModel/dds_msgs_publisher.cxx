...
void run_publisher_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    dds::pub::DataWriter<dds_msgs::DoubleUrlMsg> writer(publisher, topic, m_qos_provider.datawriter_qos("WorldPerceptionQoS::UploadDiffModelMsg"));
    ...
    for (unsigned int samples_written = 0; !application::shutdown_requested && samples_written < sample_count; samples_written++)
    {
        ...
        writer.write(data);
        std::cout << "Writing UploadDiffModelMsg, count " << samples_written << std::endl;
