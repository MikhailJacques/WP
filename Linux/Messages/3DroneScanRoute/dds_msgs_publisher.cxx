...
void run_publisher_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    //dds::pub::DataWriter<dds_msgs::DroneScanRouteMsg> writer(publisher, topic);
    dds::core::QosProvider m_qos_provider = dds::core::QosProvider::Default();
    dds::pub::DataWriter<dds_msgs::DroneScanRouteMsg> writer(publisher, topic, m_qos_provider.datawriter_qos("WorldPerceptionQoS::DroneScanRouteMsg"));

    dds_msgs::DroneScanRouteMsg data;
    for (unsigned int samples_written = 0; !application::shutdown_requested && samples_written < sample_count; samples_written++)
    {
        ...
        writer.write(data);
        std::cout << "Writing DroneScanRouteMsg, count " << samples_written << std::endl;
